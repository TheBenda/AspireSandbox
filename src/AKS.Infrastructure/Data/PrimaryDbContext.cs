...
public class PrimaryDbContext(DbContextOptions<PrimaryDbContext> dbContextOptions) : DbContext(dbContextOptions)
{
    ...
    public DbSet<BattleGroup> BattleGroups { get; set; } = null!;
    public DbSet<Unit> Units { get; set; } = null!;
    //public DbSet<OrderDetail> OrderDetails { get; set; } = null!;
    public DbSet<Equipment> Equipments { get; set; } = null!;
    public DbSet<BattleGroupUnit> BattleGroupUnits { get; set; } = null!;
    public DbSet<BattleGroupUnitEquipment> BattleGroupUnitEquipments { get; set; } = null!;
