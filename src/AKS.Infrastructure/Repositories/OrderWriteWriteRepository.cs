...
public class OrderWriteWriteRepository(PrimaryDbContext dbContext) : IOrderWriteRepository
{
    ...
    public async Task<PersistenceResult<Order>> AddProductToOrderAsync(Guid orderId, OrderItem orderItem, CancellationToken cancellationToken)
    {
